...
int main ()
{
    cout<< "Khunaify Syarief"<<endl;cout<< "*##############################################################*"<<endl;
...
```
**HASIL**
![hasil1](https://raw.githubusercontent.com/Khunaify/Praktikum4/master/hasil1.png)
...
9.cetak semua hasil perintah di atas (jumlah barang, total harga belanja, diskon yang di bertikan,harga yang harus di bayar **CODE PROGRAM**
```c++
#include<iostream>
using namespace std;
int main ()
{
    ...
    cout<< "*#####################################################*"<<endl;
    cout<<	 "|              Khunaify Syarief Yasah(311610788)      |"	<<endl;
    cout<< 	"|-----------------------------------------------------|	"<<endl;
    cout<< 	"|Tugas Praktikum4 Program Menghitung Jumlah Belanja   |	"<< endl;
    cout<< 	"|-----------------------------------------------------|	" <<endl;   int jumlah_beli=0,total_beli=0,x,y,a;
    long int
...
**HASIL**
![hasil2](https://raw.githubusercontent.com/Khunaify/Praktikum4/master/hasil2.png)
